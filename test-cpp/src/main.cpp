...
TEST_CASE("Enum to name", "[refl][enum]")
{
    ...
    REQUIRE(strcmp(Obs::Enum<Fruit>::GetName(Fruit::Apple), "Apple") == 0);
    REQUIRE(strcmp(Obs::Enum<Fruit>::GetName(Fruit::Orange), "Orange") == 0);
    REQUIRE(strcmp(Obs::Enum<Fruit>::GetName(Fruit::Banana), "Banana") == 0);
}